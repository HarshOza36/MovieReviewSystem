...
$query="Select reviews,rates from mrs.cratings where m_id in(Select mid from mrs.movie where movie_name='Avengers EndGame');";
		...
		<div class="col-lg-6 col-sm-6 text-center order-2">
			<div class="row justify-content-center">
				<div id="headingGroup" class="text-white text-center col-10 col-lg-8 d-lg-block mt-5 pt-md-3">
					<h1 class="display-2">AVENGERS END GAME</h1>
					<p class="lead">After Thanos, an intergalactic warlord, disintegrates half of the universe, the Avengers must reunite and assemble again to reinvigorate their trounced allies and restore balance. <br>
					Release date: 26 April 2019 (India) <br>
					Directors: Anthony Russo, Joe Russo <br>
					Box office: 279.6 crores USD <br>
					Budget: 35.6 crores USD (2019)</p>
...
<!-- -------------------------------------------------------LEFT SIDE ------------------------------- -->
		...
		<div class="col-lg-6 col-sm-6 hello">
			<img src="https://upload.wikimedia.org/wikipedia/en/0/0d/Avengers_Endgame_poster.jpg" class="image-fluid">
		</div>
	</div>
</section>
                        ...
                        <div id="headingGroup" class="text-white text-center ">
                            <div class="detailBox">
                                ...
                                <div class="commentBox">
                                    <p class="taskDescription"> Ratings and comments on Avengers End Game</p>
                                </div>
                                <div class="actionBox">
...
<div class="card qw">
  ...
  <div class="card-body h">
    ...
    <?php
        ...
        <input type='hidden' name='mid' value='M003'/>
