...
$query="Select reviews,rates from mrs.cratings where m_id in(Select mid from mrs.movie where movie_name='Aashiqui 2');";
    ...
    <div class="row">
                        ...
                        <div id="headingGroup" class="text-white text-center ">
                            <div class="detailBox">
                                ...
                                <div class="commentBox">
                                    <p class="taskDescription"> Ratings and comments on Aashiqui 2</p>
                                </div>
                                <div class="actionBox">
        ...
        <div class="col-sm">
                <div class="col-lg-6 col-sm-6 hello video" order 2>
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/FyXXgpPqe6w" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
        </div>
    </div>
</section>
...
<div class="card qw">
  ...
  <div class="card-body h">
    ...
    <?php
        ...
        <input type='hidden' name='mid' value='M008'/>
