...
$query="Select reviews,rates from mrs.cratings where m_id in(Select mid from mrs.movie where movie_name='Me Before You');";
		...
		<div class="col-lg-6 col-sm-6 text-center order-2">
			<div class="row justify-content-center">
				<div id="headingGroup" class="text-white text-center col-10 col-lg-8 d-lg-block mt-5 pt-md-3">
					<h1 class="display-2">ME BEFORE YOU</h1>
...
<!-- -------------------------------------------------------LEFT SIDE ------------------------------- -->
		...
		<div class="col-lg-6 col-sm-6 hello">
			<img src="http://images6.fanpop.com/image/photos/40000000/Me-Before-You-Movie-Poster-movie-trailers-40097761-464-347.jpg" class="image-fluid">
		</div>
	</div>
</section>
<!-- ------------------------------------------------COMMENTS-------------------------------- -->
    ...
    <div class="row">
                        ...
                        <div id="headingGroup" class="text-white text-center ">
                            <div class="detailBox">
                                ...
                                <div class="commentBox">
                                    <p class="taskDescription"> Ratings and comments on Me Before You</p>
                                </div>
                                <div class="actionBox">
        ...
        <div class="col-sm">
                <div class="col-lg-6 col-sm-6 hello video" order 2>
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/Eh993__rOxA" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
        </div>
    </div>
</section>
...
<div class="card qw">
  ...
  <div class="card-body h">
    ...
    <?php
        $u=$_SESSION['username'];
        echo"<form  action='http://localhost/project wdl+dbms/php/comments.php' method='POST'>
...
<div class="container">
    <div class="row">
        <div class="detailBox row jusitfy-content-center">
            <div class="actionBox">
                 <?php
                                $u=$_SESSION['username'];
                       ...
                       Write Review Here:<pre>    </pre>
                                ...
                                <br>
                                <button class='commentSubmit but1 arrow' type='submit'>Comment</button>
                                </form>"
                            ?>        
            </div>
        </div>
